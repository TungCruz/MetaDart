...
class FoodAndDrinkScreen extends StatefulWidget {
  ...
  @override
  State<FoodAndDrinkScreen> createState() =>
      _FoodAndDrinkScreenState();
}

class _FoodAndDrinkScreenState
    extends State<FoodAndDrinkScreen> {
  ...
  int get seatTotal =>
      widget.selectedSeats.length * widget.ticketPrice;

  int get foodTotal =>
      orders.fold(0, (sum, item) => sum + item.total);
